...
export const firecrawlApi = {
  ...
  // Run the promotions scraper
  async runPromotionsScraper(): Promise<FirecrawlResponse> {
  ...
  // Match user promotions
  async matchUserPromotions(userId?: string): Promise<FirecrawlResponse> {

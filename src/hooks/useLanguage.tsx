...
const translations = {
  pt: {
    ...
    'monthlyIncome.selectMonth': 'Selecione o mês',
    'monthlyIncome.categoryLabel': 'Categoria',
    'monthlyIncome.allCategories': 'Todas as categorias',
    'monthlyIncome.totalIncome': 'Total de Receitas',
    ...
    'monthlyIncome.receiptMethod': 'Forma de recebimento',
    'monthlyIncome.date': 'Data',
    'monthlyIncome.noneFound': 'Nenhuma receita encontrada para o período selecionado.',
    'monthlyIncome.firstBalance': '1º Saldo',
...
'transactionForm.paymentMethod': 'Método de Pagamento',
    ...
    'transactionForm.accountInvestmentTransfer': 'Transferência entre Conta e Investimento',
      'transactionForm.debitCard': 'Cartão de Débito',
      'transactionForm.creditCard': 'Cartão de Crédito',
      'transactionForm.paymentTransfer': 'Transferência para Pagamento',
      'transactionForm.check': 'Cheque',
    ...
    'transactionForm.selectSourceAccount': 'Selecione a conta de saída',
    'transactionForm.selectDestinationAccount': 'Selecione a conta de destino',
    'transactionForm.selectInvestment': 'Selecione o investimento',
    ...
    'subscription.premiumAccess': 'Você tem acesso premium.',
    ...
    'subscription.annualDiscount': 'No plano anual você tem um desconto de aproximadamente 25%.',
    'subscription.includesEssential': 'Inclui todos os recursos do plano Essencial:',
    'subscription.subscribeMonthly': 'Assinar Mensal',
    'subscription.subscribeAnnually': 'Assinar Anual',
    ...
    // Auth
    'auth.appName': 'Financial App',
    'auth.tagline': 'Gerencie suas finanças em casal',
    'auth.signIn': 'Entrar',
    ...
    'auth.tempPasswordPlaceholder': 'Senha enviada por e-mail',
    ...
    'auth.inviteBanner': 'Você foi convidado para o Couples Financials. Use a senha enviada por e-mail para acessar o sistema.',
    'auth.loginSuccessTitle': 'Login realizado com sucesso!',
    'auth.loginSuccessDesc': 'Redirecionando para o dashboard...',
    'auth.loginErrorTitle': 'Erro no login',
    'auth.loginErrorDesc': 'Erro ao fazer login. Verifique suas credenciais.',
    'auth.googleErrorTitle': 'Erro no login com Google',
    'auth.signupSuccessTitle': 'Conta criada com sucesso!',
    'auth.signupSuccessDesc': 'Um email de confirmação foi enviado para sua caixa de entrada. Clique no link do email para ativar sua conta.',
    'auth.signupErrorTitle': 'Erro no cadastro',
    'auth.signupErrorDesc': 'Erro ao criar conta.',
    'auth.emailRequiredTitle': 'Email necessário',
    'auth.emailRequiredDesc': 'Por favor, insira seu email para redefinir a senha.',
    'auth.resetEmailTitle': 'Email de redefinição enviado!',
    'auth.resetEmailDesc': 'Verifique sua caixa de entrada e siga as instruções.',
    'auth.resetEmailErrorTitle': 'Erro ao enviar email',
    'auth.resetEmailErrorDesc': 'Não foi possível enviar o email de redefinição.',
  },
  en: {
    // Dashboard
    ...
    'monthlyIncome.totalIncome': 'Total Income',
    'monthlyIncome.periodIncome': 'Income for the Period',
    ...
    'monthlyIncome.noneFound': 'No income found for the selected period.',
    'monthlyIncome.firstBalance': '1st Balance',
    ...
    'transactionForm.accountTransfer': 'Transfer Between Accounts',
    'transactionForm.accountInvestmentTransfer': 'Transfer Between Account and Investment',
    ...
    'transactionForm.selectSourceAccount': 'Select source account',
    'transactionForm.selectDestinationAccount': 'Select destination account',
    ...
    'categories.placeholder': 'e.g., Food, Transport...',
    ...
    'categories.none': 'No categories yet. Create your first one!',
    ...
    'subscription.premiumAccess': 'You have premium access.',
    ...
    // Auth
    'auth.appName': 'Financial App',
    'auth.tagline': 'Manage your finances as a couple',
    'auth.signIn': 'Sign in',
    'auth.signUp': 'Sign up',
    'auth.email': 'Email',
    ...
    'auth.tempPasswordPlaceholder': 'Temporary password sent by email',
    ...
    'auth.inviteBanner': 'You were invited to Couples Financials. Use the password sent by email to access the system.',
    'auth.loginSuccessTitle': 'Login successful!',
    'auth.loginSuccessDesc': 'Redirecting to dashboard...',
    'auth.loginErrorTitle': 'Login error',
    'auth.loginErrorDesc': 'Error logging in. Please check your credentials.',
    'auth.googleErrorTitle': 'Google login error',
    'auth.signupSuccessTitle': 'Account created successfully!',
    'auth.signupSuccessDesc': 'A confirmation email has been sent to your inbox. Click the link to activate your account.',
    'auth.signupErrorTitle': 'Sign up error',
    'auth.signupErrorDesc': 'Error creating account.',
    'auth.emailRequiredTitle': 'Email required',
    'auth.emailRequiredDesc': 'Please enter your email to reset your password.',
    'auth.resetEmailTitle': 'Password reset email sent!',
    'auth.resetEmailDesc': 'Check your inbox and follow the instructions.',
    'auth.resetEmailErrorTitle': 'Error sending email',
    'auth.resetEmailErrorDesc': 'Could not send the reset email.',
  },
};

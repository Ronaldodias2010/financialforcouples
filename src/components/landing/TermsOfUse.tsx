            ...
            <CardContent className="p-8">
              <div className="flex items-center justify-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-semibold">
                  {language === 'pt' ? 'Dúvidas sobre os Termos?' : 'Questions about Terms?'}
                </h3>
              </div>
              <p className="text-muted-foreground mb-6">
                {language === 'pt' 
                  ? 'Entre em contato conosco para esclarecer qualquer dúvida sobre nossos termos de uso.'
                  : 'Contact us to clarify any questions about our terms of use.'
                }
              </p>
              <Button asChild>
                <a href={`mailto:${language === 'pt' ? 'suporte@couplesfinancials.com' : 'support@couplesfinancials.com'}`}>

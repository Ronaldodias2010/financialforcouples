      ...
      <div className="container mx-auto px-4" ref={ref as any}>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {securityFeatures.map((feature, index) => (
            <div
              key={index}
              className={`group relative p-6 rounded-xl border bg-card/50 backdrop-blur-sm hover:bg-card/80 transition-all duration-500 hover:shadow-lg hover:shadow-primary/10 hover:-translate-y-1 ${
                inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}
        ...
        <div className={`bg-card/30 backdrop-blur-sm rounded-2xl p-8 border transition-all duration-1000 ${
          inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
        }`}>
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-center">
              ...
              <Button
                variant="outline"
                className="bg-background/50 hover:bg-background border-primary/20 hover:border-primary/40"
              >
                {t('security.cta')}
              </Button>
            </div>

...
const translations = {
  pt: {
    ...
    'whatsapp.alt': 'Chat do WhatsApp com assistente financeiro',
    'whatsapp.recording': 'Gravando...',
    'whatsapp.howitworks.title': 'Como funciona o input por voz',
    ...
    'whatsapp.benefits.title': 'Vantagens do input por voz:',
    'whatsapp.benefits.nlu': 'IA entende linguagem natural',
    // Final CTA Section
  ...
  en: {
    ...
    'whatsapp.alt': 'WhatsApp chat with financial assistant',
    'whatsapp.recording': 'Recording...',
    'whatsapp.howitworks.title': 'How voice input works',
    ...
    'whatsapp.step3.title': 'Confirm and save',
    'whatsapp.step3.description': 'Expense added instantly',
    'whatsapp.benefits.title': 'Advantages of voice input:',
    'whatsapp.benefits.nlu': 'AI understands natural language',
    // Final CTA Section
  ...
  es: {
    ...
    'whatsapp.alt': 'Chat de WhatsApp con asistente financiero',
    'whatsapp.recording': 'Grabando...',
    'whatsapp.howitworks.title': 'Cómo funciona la entrada por voz',
    'whatsapp.step1.title': 'Envía un mensaje de voz',
    'whatsapp.step1.example': '"Gasté $45 en el almuerzo hoy"',
    'whatsapp.step2.title': 'La IA procesa automáticamente',
    'whatsapp.step2.description': 'Reconoce monto, categoría y fecha',
    'whatsapp.step3.title': 'Confirma y registra',
    'whatsapp.step3.description': 'Gasto añadido al instante',
    'whatsapp.benefits.title': 'Ventajas de la entrada por voz:',
    'whatsapp.benefits.nlu': 'La IA entiende lenguaje natural',
    // Final CTA Section

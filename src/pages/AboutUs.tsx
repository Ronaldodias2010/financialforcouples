  ...
  const content = {
    pt: {
      ...
      story: {
        ...
        description: "Nascemos de uma necessidade real, somos casados a 21 anos: éramos um casal em busca de uma solução completa para organizar suas finanças. Todo início de mês era marcado por confusão, discussões e brigas. Não entendíamos como dois executivos, com salários elevados, não conseguiam terminar o mês com dinheiro sobrando. Imagina se era difícil para nós, como seria para quem ganha pouco. Sempre discutíamos, cada um analisava a planilha de gastos do outro, mas ninguém conseguia identificar onde estava o problema. Até que percebemos: se trabalhássemos juntos, de forma colaborativa, poderíamos resolver essa questão que afetava profundamente nosso relacionamento. No entanto, não encontramos nenhuma ferramenta prática que realmente nos ajudasse. Observamos que o mercado oferecia apenas soluções individuais. Algumas plataformas até permitiam o controle de gastos em família, mas eram frias, desconectadas da realidade dos casais. Foi então que decidimos criar nossa própria plataforma — feita sob medida para nossas finanças. Ela nos ajuda a identificar quando estamos no vermelho e, com o apoio de uma inteligência artificial, nos orienta a sair dessa situação e a evitar que ela se repita. Ao implementar essa solução, percebemos que muitos outros casais enfrentavam o mesmo desafio. Assim nasceu a Couples Financials — a melhor plataforma para cuidar do seu dinheiro e construir planos para o futuro, seja em casal ou solteiro."
      },
      mission: {
        title: "Nossa Missão",

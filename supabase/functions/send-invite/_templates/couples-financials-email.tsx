...
export default CouplesFinancialsEmail
...
const credentialsBox = {
  ...
  border: '2px solid #F59E0B', // --primary
  borderRadius: '8px',
  padding: '20px',
  margin: '24px 0',
}
...
const passwordCode = {
  ...
  color: '#0f0f23', // --secondary-foreground
...
const button = {
  ...
  boxShadow: '0 10px 30px -10px rgba(245, 158, 11, 0.3)', // --shadow-gold
}

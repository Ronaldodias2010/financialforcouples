...
export const MagicLinkEN = ({ userEmail, loginUrl }: MagicLinkProps) => {
  return React.createElement(
    Html,
    null,
    React.createElement(Head, null),
    React.createElement(Preview, null, "✅ Email verified — continue to payment"),
    React.createElement(
      Body,
      { style: main },
      React.createElement(
        ...
        React.createElement(
          Text,
          { style: text },
          `Hi ${userEmail}, your verification is complete.`
        ),
        React.createElement(
          Text,
          { style: text },

...
-- Create a comprehensive constraint that includes all existing payment methods plus 'saque'
...
CHECK (payment_method IN (
  ...
  'boleto', 'financing', 'installment', 'saque', 'outros',
  'account_transfer', 'deposit', 'payment_transfer', 'transfer'
));

-- Update the process_withdrawal function to ensure it works correctly

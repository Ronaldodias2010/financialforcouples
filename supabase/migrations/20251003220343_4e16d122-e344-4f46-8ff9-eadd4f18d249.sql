...
BEGIN
  FOR expense_record IN 
    ...
    WHERE is_active = true 
      ...
      AND remaining_installments > 0
  LOOP
    next_expense_date := expense_record.next_due_date;
    ...
    FOR i IN 1..months_ahead LOOP
      ...
      IF NOT EXISTS (
        ...
        WHERE user_id = expense_record.user_id
          ...
          AND due_date = next_expense_date
          AND is_paid = false
      ) THEN
      ...
      ELSE
        next_expense_date := next_expense_date + (expense_record.frequency_days || ' days')::interval;
      END IF;
